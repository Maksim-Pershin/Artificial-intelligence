...
def main():
    ...
    print("   👤  Запоминание имени")
    print("   💬  Разговорные ответы")
    print("   ❓  Помощь и справка")
    print("   👋  Приветствия и прощания")
    print("=" * 70)
    print()
